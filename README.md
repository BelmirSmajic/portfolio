...
Data, business, and product analytics across healthcare cost, contract strategy, product integration, and decision support.
...
4. World Cup Weakest Link Analysis  
...
Professional project visuals use synthetic data created to demonstrate the original analytical workflows. No employer, member, provider, contract, supplier, or product data is displayed. The World Cup analysis uses public data and links to its full public analysis.
